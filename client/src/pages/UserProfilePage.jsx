      ...
      <div className="bg-white shadow-md rounded-lg p-4">
        ...
        <div className="border-b border-gray-300 pb-4 bg-green-100 color-green-600 text-center items-center">
          <ul className="flex space-x-4 text-center items-center justify-center">
            <li
              className={`cursor-pointer ${activeTab === 'attendance' && 'font-semibold border-b-2 border-green-500'
                }`}
            ...
            <li
              className={`cursor-pointer ${activeTab === 'salaryHistory' && 'font-semibold border-b-2 border-green-500'
                }`}
            ...
            <li
              className={`cursor-pointer ${activeTab === 'salaryReport' && 'font-semibold border-b-2 border-green-500'
                }`}
