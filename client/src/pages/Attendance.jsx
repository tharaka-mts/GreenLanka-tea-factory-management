    ...
    <div>
      ...
      <div class="min-h-screen flex flex-wrap items-center  justify-center  ">
        ...
        <div class="flex flex-col sm:flex-col lg:flex-row xl:flex-row md:flex-row justify-center items center  container">
          ...
          <div class="py-12 sm:py-12 md:py-6 lg:py-6 xl:py-6 px-8 w-full md:max-w-[20%] sm:w-full bg-white z-30">
          ...
          <div class="py-12 sm:py-12 md:py-6 lg:py-6 xl:py-6 px-8 w-full md:max-w-[20%] sm:w-full bg-white z-30">
            <h1 style={{ color: currentColor }} class="mt-4 font-semibold text-3xl text-center">Tea Pluckers</h1>

            <div class="text-center mt-3">
              <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-2 rounded-2xl ">
                <p className="text-center font-semibold text-2xl">Present</p>
                <p className="text-center font-semibold text-2xl mt-3 ">22</p>
              </div>
