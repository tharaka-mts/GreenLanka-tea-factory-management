...
const Login = () => {
    ...
    return (
        ...
        <>
            ...
            <section class="h-screen w-full bg-green-500">
            <h1 className=' text-center text-4xl pt-5 text-white font-bold '>Welcome to Green Lanka Tea Factory</h1>

               
                <div class=" flex justify-center content-center items-center m-auto " >
             
                    <div className='
                     flex justify-center content-center items-center w-[800px]  h-[500px] mt-5'>

                        <div
                            class="g-6 flex flex-wrap content-center items-center justify-center lg:justify-between bg-gray-500">
                            <div
                                class="bg-white  shrink-1 mb-12 grow-0 basis-auto md:mb-0 md:w-9/12 md:shrink-0 lg:w-6/12 xl:w-6/12 justify-center items-center">
                            ...
                            <div class="mt-6 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12 items-center px-8 bg-gray-500">
                                <form className='pr-5'>
                              
                                    <div
                                        class="flex flex-row items-center justify-center lg:justify-start">
                                        <h3 class="mb-0 mr-4 text-lg font-weight-700 pt-5 ">Login</h3>
