  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        <img src={user} className="w-[100px] h-[100px]" alt="Sample image" />
      </div>
      ...
      <div className="w-80%">
        <div className="flex justify-center w-full h-screen">
          <div className="bg-white mt-10 flex h-[700px]">
            ...
            >
              <div
                class="bg-white shadow-md rounded relative"
              ...
              <div
                class="bg-white shadow-md rounded relative mb-6 mt-6 flex flex-row"
                data-te-input-wrapper-init
              >
